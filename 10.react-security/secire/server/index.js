...
import jwtAuth from "express-jwt-authz";
...
const secureAPI = jwt({
  ...
  audience: "https://www.seanlinkedin.com",
  issuer: "dev-66hur-ly.auth0.com",
  algorithms: ["R5256"]
});

const checkScopes = jwtAuth(["read-courses"]);
...
app.get("/courses", secureAPI, checkScopes, (req, res) => {
  let courses = [
    ...
    },
    {
      ...
      link:
        "https://www.lynda.com/FramerJS-tutorials/Prototype-Mobile-CRM-Application-Framer/587677-2.html",
      description:
    ...
    },
    {
      ...
      link:
        "https://www.lynda.com/React-js-tutorials/React-Ecosystems/601831-2.html",
      description:
    ...
    },
    {
      ...
      link:
        "https://www.lynda.com/React-js-tutorials/React-Testing-Debugging/592511-2.html",
      description:
    ...
    },
    {
      ...
      link:
        "https://www.lynda.com/Craft-tutorials/InVision-Craft-UX-Design/599634-2.html",
      description:
    ...
    },
    {
      ...
      link:
        "https://www.lynda.com/InVision-tutorials/InVision-UX-Design/599633-2.html",
      description:
    ...
    },
    {
      ...
      link:
        "https://www.lynda.com/GraphQL-tutorials/GraphQL-Data-Fetching-Relay/595829-2.html",
      description:
